<?php
	...
	if(isset($_POST['update'])){
		...
		$up="UPDATE contestant SET contestant_towncity='$towncity', contestant_provincestate='$provincestate', contestant_country='$country'";
  ...
  <div class="cont">
    ...
    <div class="body_content_dash container-fluid">
			<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
				...
				<div class="row">
					<div class="col-xs-6">
						<input class="in_form" type="text" name="towncity" placeholder="Town/city" value="<?php echo $row['contestant_towncity']; ?>" required />
					</div>
				</div>
				<div class="row">
					<div class="col-xs-6">
